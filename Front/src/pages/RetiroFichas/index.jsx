  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:5000/api/users/${phoneNumber}/balance/retiro`,
        {
    ...
    <>
      ...
      <AcordeonContainer className="m-5">
        <div className="container form-carga">
          <h2 className="text-center text-white">Retiro de saldo</h2>
          <Form onSubmit={handleSubmit} className="w-25">
            ...
            <Form.Group controlId="newBalance" className="mt-4">
              <Form.Label className="text-white">Saldo a retirar:</Form.Label>
              <Form.Control
                type="number"
